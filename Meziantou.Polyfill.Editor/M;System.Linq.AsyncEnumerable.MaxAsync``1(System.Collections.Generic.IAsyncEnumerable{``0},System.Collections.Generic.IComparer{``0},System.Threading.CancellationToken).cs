...
#pragma warning disable CA2012 // Use ValueTasks correctly
        ...
        {
            return (ValueTask<TSource?>)(object)Helpers.MaxAsync((IAsyncEnumerable<float>)(object)source, cancellationToken);
        }

        if (typeof(TSource) == typeof(double) && comparer == Comparer<TSource>.Default)
        {
            return (ValueTask<TSource?>)(object)Helpers.MaxAsync((IAsyncEnumerable<double>)(object)source, cancellationToken);
        }
...
{
    public static async ValueTask<float> MaxAsync(
    ...
    public static async ValueTask<double> MaxAsync(
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> to monitor for cancellation requests. The default is <see cref="CancellationToken.None"/>.</param>
    /// <returns>The maximum value in the sequence.</returns>
    public static async ValueTask<float?> MaxAsync(IAsyncEnumerable<float?> source, CancellationToken cancellationToken)
    {
        float? value = null;
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> to monitor for cancellation requests. The default is <see cref="CancellationToken.None"/>.</param>
    /// <returns>The maximum value in the sequence.</returns>
    public static async ValueTask<double?> MaxAsync(IAsyncEnumerable<double?> source, CancellationToken cancellationToken)
    {
        double? value = null;
