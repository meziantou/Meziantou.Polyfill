...
{
    /// <summary>
    /// Asynchronously saves this <see cref="XDocument"/> to a <see cref="TextWriter"/>.
    /// </summary>
    /// <param name="document">The document to save.</param>
    /// <param name="textWriter">The text writer to which to save the document.</param>
    ...
    async
#endif
    Task SaveAsync(this XDocument document, TextWriter textWriter, SaveOptions options, CancellationToken cancellationToken)
    {
#if NETCOREAPP2_1_OR_GREATER || NETSTANDARD2_1_OR_GREATER
        if (document is null)
        ...
        document.Save(textWriter, options);
