...
static partial class PolyfillExtensions
{
    public static int SplitAny(this ReadOnlySpan<char> source, Span<Range> destination, ReadOnlySpan<string> separators, StringSplitOptions options = StringSplitOptions.None) =>
        SpanSplitImplementation.Split(source, destination, separators.ToArray(), options);
}
...
file static class SpanSplitImplementation
{
    ...
    public static int Split(ReadOnlySpan<char> source, Span<Range> destination, string[] separators, StringSplitOptions options) =>
        Split(source, destination, separators, any: true, options);
