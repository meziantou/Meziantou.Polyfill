...
Please read these guidelines before contributing to meziantou/Meziantou.Polyfill:
...
If you have questions about how to use meziantou/Meziantou.Polyfill, please open a GitHub issue.
...
- Check that new and updated code follows meziantou/Meziantou.Polyfill's existing code formatting and naming standard
- Run meziantou/Meziantou.Polyfill's unit tests to ensure no existing functionality has been affected
...
By contributing your code to meziantou/Meziantou.Polyfill you grant Gérald Barré a non-exclusive, irrevocable, worldwide,
