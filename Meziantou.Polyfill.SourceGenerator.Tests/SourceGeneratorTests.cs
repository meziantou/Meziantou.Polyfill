...
{
    private const string LatestDotnetSdkVersion = "11.0.100-preview.6.26359.118";
    private static readonly string LatestDotnetPackageVersion = LatestDotnetSdkVersion.Replace(".100-", ".0-", StringComparison.Ordinal);
    ...
    public static TheoryData<PackageReference[], bool> GetConfigurations()
    {
        var packagesCombination = new List<PackageReference[]>
        {
            ...
            { new[] { new PackageReference("Microsoft.NETFramework.ReferenceAssemblies.net462", "1.0.3", ""), new PackageReference("Microsoft.Bcl.Memory", "10.0.8", "lib/net462/") } },
