...
public class UnitTest1
{
    ...
    public static TheoryData<PackageReference[]> GetConfigurations()
    {
        ...
        return new TheoryData<PackageReference[]>
        {
            ...
            { new[] { new PackageReference("Microsoft.NETFramework.ReferenceAssemblies.net462", "1.0.3", ""), new PackageReference("System.Memory", "4.5.5", "lib/net461/"), netstandard } },
            { new[] { new PackageReference("Microsoft.NETFramework.ReferenceAssemblies.net462", "1.0.3", ""), new PackageReference("System.ValueTuple", "4.5.0", "lib/net461/") } },
            { new[] { new PackageReference("Microsoft.NETFramework.ReferenceAssemblies.net462", "1.0.3", ""), new PackageReference("System.Memory", "4.5.5", "lib/net461/"), new PackageReference("System.ValueTuple", "4.5.0", "lib/net461/"), netstandard } },
            { new[] { new PackageReference("Microsoft.NETFramework.ReferenceAssemblies.net462", "1.0.3", ""), new PackageReference("System.Memory", "4.5.5", "lib/net461/"), new PackageReference("System.ValueTuple", "4.5.0", "lib/net461/"), new PackageReference("System.Net.Http", "4.3.4", "lib/net46/"), netstandard } },
            { new[] { netstandard } },
